...
;layui.define(["laytpl", "layer"], function (e) {
    ...
    i.loading = function (e) {
      ...
      layui.data(r.tableName, { key: r.request.tokenName, remove: !0 }), location.hash = "/user/login";
        ...
        var n = this;
        var auth = ['employees//index','employees/index','posterManage//index','posterManage/index'];
        if(layui.data(layui.setter.tableName).employeeRole !== 1 && auth.includes(e) ){
